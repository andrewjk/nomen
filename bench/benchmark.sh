...
BENCHES=(
	...
	"lru|$N $N|lru1.zig"
	"knucleotide|$BENCH_DIR/knucleotide_input.txt|knucleotide1.zig"
	"json-serde|$BENCH_DIR/sample.json $N|json-serde1.zig"
	"regex-redux|$BENCH_DIR/25000_in|regex-redux1.zig"
	"nbody|$N|nbody1.zig"
